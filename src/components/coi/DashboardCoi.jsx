...
const DashboardCoi = () => {
  ...
  const dataPieCoi = [
    { label: "> 6 Bulan", value: countcoi.coi_more_than_six_months || 0, color: "#06d6a0" },
    { label: "< 6 Bulan", value: countcoi.coi_less_than_six_months || 0, color: "#ffd166" },
    { label: "Expired", value: countcoi.coi_expired || 0, color: "#ef476f" },
  ];

  const dataPieRla = [
    { label: "> 6 Bulan", value: countcoi.rla_more_than_six_months || 0, color: "#06d6a0" },
    { label: "< 6 Bulan", value: countcoi.rla_less_than_six_months || 0, color: "#ffd166" },
