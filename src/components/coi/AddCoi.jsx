    ...
    <div className="flex flex-col md:flex-row w-full">
        ...
        <div className="flex flex-col md:pl-64 w-full px-2 py-4 space-y-3">
            <div className="w-full bg-white shadow-sm px-2 py-4 rounded-lg space-y-2"> 
                ...
                <div>
                    <form method="post" encType='multipart/form-data' onSubmit={(e) => handleAddCoi(e)}>
                        <div className="flex flex-col space-y-2">
                            <div className='flex flex-row space-x-2'>
                                ...
                                <div className='w-full' >
                                    <label htmlFor="category" className="text-emerald-950">Kategori <sup className='text-red-500'>*</sup></label>
                                    <select
                                        name="category_id"
                                        id="category"
                                        className="w-full px-1 py-2 border border-gray-300 rounded-md"
                            ...
                            <div className='flex flex-row space-x-2'>
                                <div className='w-full' >
                                    <label htmlFor="type" className="text-emerald-950">Tipe <sup className='text-red-500'>*</sup></label>
                                    <select
                                        name="type_id"
                                        id="type"
                                        className="w-full px-1 py-2 border border-gray-300 rounded-md"
                                ...
                                <div className='w-full' >
                                    <label htmlFor="tag_number" className="text-emerald-950">Tag Number <sup className='text-red-500'>*</sup></label>
                                    <select
                                        name="tag_number_id"
                                        id="tag_number"
                                        className="w-full px-1 py-2 border border-gray-300 rounded-md"
                            ...
                            <div className='flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2'>
                                ...
                                <div className='w-full' >
                                    <label className='text-emerald-950' htmlFor='coi_certificate'>COI Certificate <sup className='text-red-500'>*</sup></label>
                                    <input
                                        type="file"
                            ...
                            </div>
                            {
                                ...
                                <div className='space-y-2'>
                                    ...
                                    <div className='w-full'>
                                        <label className='text-emerald-950' htmlFor='rla_certificate'>RLA Certificate</label>
                                        <input
                                            type="file"
                                            name="file_rla"
                                            id="rla_certificate"
