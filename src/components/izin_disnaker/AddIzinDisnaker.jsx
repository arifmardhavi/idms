...
import { addIzinDisnaker } from '../../services/izin_disnaker1.service';
...
const AddIzinDisnaker = () => {
  ...
  const handleAddIzinDisnaker = async (e) => {
    e.preventDefault();
    ...
    try {
      ...
      formData.append('izin_disnaker_certificate', e.target.izin_disnaker_certificate.files[0]);
      ...
      const res = await addIzinDisnaker(formData);
      if (res.success) {
        Swal.fire("Berhasil!", "Izin Disnaker berhasil ditambahkan!", "success");
        navigate('/izin_disnaker');
      } else {
        setValidation(res.response?.data.errors || []);
        Swal.fire("Gagal!", "Izin Disnaker gagal ditambahkan!", "error");
      }
    } catch (error) {
      console.error("Error adding Izin Disnaker:", error);
      setValidation(error.response?.data.errors || []);
      Swal.fire("Error!", "Terjadi kesalahan saat menambahkan Izin Disnaker!", "error");
    } finally {
      ...
      { !hide && <Header />}
        ...
        <div className='w-full bg-white shadow-sm px-2 py-4 rounded-lg space-y-2'>
          ...
          >
            ...
            <Typography className='text-lime-500'>Tambah Izin Disnaker</Typography>
          </Breadcrumbs>
          <div>
            <form
              method='post'
              encType='multipart/form-data'
              onSubmit={(e) => handleAddIzinDisnaker(e)}
            >
                ...
                <div className='flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2'>
                  ...
                  <div className='w-full'>
                    <label
                      ...
                      htmlFor='izin_disnaker_certificate'
                    >
                      Izin Disnaker Certificate <sup className='text-red-500'>*</sup>
                    </label>
                    <input
                      type='file'
...
export default AddIzinDisnaker;