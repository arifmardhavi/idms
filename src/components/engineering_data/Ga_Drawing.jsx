...
const Ga_Drawing = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const files = e.target.drawing_file.files;
            ...
            >
              ...
              >
                <h2
                  ...
                  className="text-emerald-950 font-bold uppercase text-center"
                >
                  Tambah Drawing
                </h2>
                ...
                <form method="post" encType="multipart/form-data" onSubmit={handleSubmit}>
                  <div className="flex flex-row justify-center items-center">
                    {isMultiple ? (
                      <div
                        className="text-lime-300 bg-emerald-950 w-fit p-1 rounded text-sm flex justify-center items-center cursor-pointer"
                        onClick={() => setIsMultiple(false)}
                      >
                        <IconFiles /> &nbsp; Multiple File Upload Mode
                      </div>
                    ) : (
                      <div
                        className="bg-lime-300 text-emerald-950 w-fit p-1 rounded text-sm flex justify-center items-center cursor-pointer"
                        onClick={() => setIsMultiple(true)}
                      >
                        <IconFile /> &nbsp; Single File Upload Mode
                      </div>
                    )}
                  </div>
                  ...
                  <div className="m-2">
                    <div className="text-emerald-950">Upload Drawing File</div>
                    <input
                      type="file"
                      id="drawing_file"
                      name="drawing_file[]"
                  ...
                  {!isMultiple && (
                    <div className="m-2">
                      <div className="text-emerald-950">Tanggal Dokumen</div>
                      <input
                        type="date"
                        id="date_drawing"
                        name="date_drawing"
                        ...
                        required
                      />
                      {validation.date_drawing &&
                        validation.date_drawing.map((item, index) => (
                          <div key={index} className="text-red-600 text-sm">
                            {item}
                          </div>
                        ))}
                  ...
                  {editDrawing && <form method="post" encType="multipart/form-data" onSubmit={handleSubmitEdit}>
                    <div className="m-2">
                      ...
                      <input
                        ...
                        className="w-full p-2 rounded border"
                        placeholder="Masukkan nomor dokumen"
                        defaultValue={editDrawing.no_dokumen}
                      />
