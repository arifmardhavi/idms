...
const MonitoringContract = () => {
  ...
  const fetchMonitoringContract = async () => {
    try {
      ...
      console.log("Monitoring Contract Data:", response.data)
    } catch (error) {
...
const monitoring_durasi = [
  {
    ...
    value: monitoringContract.monitoring_durasi_mpp.blue ?? 0,
    color: '#51a2ff',
  },
  {
    label: 'Durasi >= 4 Minggu',
    value: monitoringContract.monitoring_durasi_mpp.green ?? 0,
    color: '#00c950',
  },
  {
    label: 'Durasi < 4 Minggu',
    value: monitoringContract.monitoring_durasi_mpp.yellow ?? 0,
    color: '#ffdf20',
  },
  {
    label: 'Durasi <= 0',
    value: monitoringContract.monitoring_durasi_mpp.red ?? 0,
    color: '#ff6467',
  },
];
const monitoring_progress_pekerjaan = [
  {
    label: 'Kontrak Selesai',
    value: monitoringContract.monitoring_progress_pekerjaan.blue ?? 0,
    color: '#51a2ff',
  },
  {
    label: 'Deviasi Aktual & Plan 0%',
    value: monitoringContract.monitoring_progress_pekerjaan.green ?? 0,
    color: '#00c950',
  },
  {
    label: 'Deviasi Aktual & Plan <= 20%',
    value: monitoringContract.monitoring_progress_pekerjaan.yellow ?? 0,
    color: '#ffdf20',
  },
  {
    label: 'Deviasi Aktual & Plan > 20%',
    value: monitoringContract.monitoring_progress_pekerjaan.red ?? 0,
    color: '#ff6467',
  },
  // {
  //   label: 'Belum Upload Dokumen Amandemen',
  //   value: monitoringContract.monitoring_progress_pekerjaan.black ?? 0,
  //   color: '#002c22',
  // },
];
