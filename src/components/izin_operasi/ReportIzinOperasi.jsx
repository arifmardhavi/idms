...
import { addReport, deleteReport, getReportByIzinOperasi } from "../../services/report_izin_operasi.service"
...
const ReportIzinOperasi = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('izin_operasi_id', id);
      ...
      console.error("Error adding REPORT Izin Operasi:", error);
    } finally {
  ...
  const handleDelete = async (row) => {
      const result = await Swal.fire({
        ...
        text: "File Report Izin Operasi akan dihapus secara permanen!",
        icon: "warning",
      ...
      if (result.isConfirmed) {
        try {
          ...
          if (res.success) {
            Swal.fire("Berhasil!", "Report Izin Operasi berhasil dihapus!", "success");
            fetchReport();
          } else {
            Swal.fire("Gagal!", "Terjadi kesalahan saat menghapus Report Izin Operasi!", "error");
          }
        } catch (error) {
          console.log(error);
          Swal.fire("Gagal!", "Terjadi kesalahan saat menghapus Report Izin Operasi!", "error");
                ...
                >
                  ...
                  <form method="post" encType="multipart/form-data" onSubmit={handleSubmit}>
                    <div className="m-2">
                      ...
                      <input
                        type="file"
                        id="report_izin_operasi"
                        name="report_izin_operasi"
...
export default ReportIzinOperasi